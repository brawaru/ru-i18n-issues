	...
	Explosion = (function() {
	  ...
	  function Explosion() {
		...
		if (confirmation != null) {
		  ...
		  this.confirmation.innerHTML = "<span style='font-weight:bold;'>fontBomb загружен!</span> Кликайте в любом месте, чтобы уничтожить элементы страницы";
		  ...
		  setTimeout(function() {
			...
			return setTimeout(function() {
			  _this.confirmation.innerHTML = "Если этот скрипт показался вам просто бомбой, подпишитесь на <a href='http://www.twitter.com/plehoux'>@plehoux в Twitter</a> за другими экспериментами!";
