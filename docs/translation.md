...
{% include gif.html src="../files/island.mp4" alt="Анимация с летающим островом" %}
...
![Скриншот редактора Crowdin](../files/crowdin_editor.webp)
...
Каждый переводчик может исправить свои переводы, используя меню «File» → «Replace in Translations...». В поле «Find» необходимо будет ввести искомое слово или предложение, а в «Replace With» его замену. **Прежде чем нажать «Replace», проверьте исправления, нажав «Preview»**.
...
{% include captioned_image.html src="../files/panel_and_translations.webp" alt="Панель голосования" caption="Панель предложений снизу. Рядом с каждым вариантом результат голосования." %}

Без голосования невозможно определить и утвердить самый лучший вариант.
